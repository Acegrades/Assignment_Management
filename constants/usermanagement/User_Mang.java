package com.acegrades.constants.usermanagement;
...
public class User_Mang 
{
	...
	public static String loginuname="praveenaa10@gmail.com"; // <-
	public static String loginpwd="abcd1234";
	public static String lu="praveenaa10@gmail.com"; // <-
	public static String lp="abcd1234";
	public static String loginpuname="praveenn10@gmail.com"; // <-
	...
	public static String Teditprofilelogin="praveenaa10@gmail.com"; // <-
	public static String Teditprofilepwd="abcd1234";
	public static String Peditprofilelogin="praveenn10@gmail.com";  // <-
	...
	public static String oldpwdwrongemail="praveenaa10@gmail.com"; // <-
	public static String oldpwdwrong="abcd1234";
	public static String oldpwdnotemail="praveenaa10@gmail.com"; // <-
	public static String oldpwdnotgiven="abcd1234";
	public static String confirmpwdemail="praveenaa10@gmail.com"; // <-
	public static String confirmpwd="abcd1234";
	public static String minlepwdemail="praveenaa10@gmail.com"; // <-
	public static String minlenpwd="abcd1234";
	public static String rosterlastname="praveenaa10@gmail.com"; // <-
	public static String rosterlastpwd="abcd1234";
	public static String dupename="praveenaa10@gmail.com"; // <-
	public static String duppwd="abcd1234";
	public static String editoptionname="praveenaa10@gmail.com"; // <-
	public static String editoptionpwd="abcd1234";
	public static String editminname="praveenaa10@gmail.com"; // <-
	public static String editminpwd="abcd1234";
	public static String editnlastname="praveenaa10@gmail.com"; // <-
	public static String editlastpwd="abcd1234";
	public static String beloweditnlastname="praveenaa10@gmail.com"; // <-
	public static String editlastnamepwd="abcd1234";
	public static String updatestuname="praveenaa9@gmail.com"; // <-
	public static String updatestupwd="abcd1234";
	 ...
	 //11.Edit Profile with Failure Message when old password is wrong. 
	   ...
	   //13.Edit Profile with Failure Message when new and confirm password do not match.
	    ...
	    public int TC_555(String upname, String uppwd)
	    {
	    	  driver.findElement(By.linkText("LOG IN")).click();
		      driver.findElement(By.id("email")).sendKeys(upname);
	      	  driver.findElement(By.id("password")).sendKeys(uppwd);
	      	  driver.findElement(By.id("loginId")).click();
	      	  
	      	driver.findElement(By.xpath("//div/div[2]/div[3]/div[2]/div/div[2]/div[2]/a[1]")).click();
	      	driver.findElement(By.partialLinkText("Praveen Shai")).click();
	      	driver.findElement(By.xpath("//div/div[2]/div[5]/div[1]/div/a[1]")).click();
	      	driver.findElement(By.xpath("//div[2]/div[5]/div[1]/div/div[2]/div[6]/img")).click();
	      	driver.findElement(By.id("fullname")).clear();
	      	driver.findElement(By.id("fullname")).sendKeys("Automation Praveen");
	      	driver.findElement(By.xpath("//div[2]/div[5]/div[2]/form/div[3]/h4/a")).click();
	      	driver.findElement(By.id("school")).sendKeys("Infofactors");
	      	driver.findElement(By.xpath("//div[2]/div[5]/div[2]/form/div[4]/h4/a")).click();
	      	driver.findElement(By.id("school")).sendKeys("5");
	      	driver.findElement(By.xpath("//div[2]/div[5]/div[2]/form/div[5]/h4/a")).click();
	      	driver.findElement(By.id("oldpassword")).clear();
	      	driver.findElement(By.id("oldpassword")).sendKeys("Praveen");
	      	driver.findElement(By.xpath("//div/div[2]/div[5]/div[2]/div/button[1]")).click();
	    ...
	    public static void main(String[] args) throws InterruptedException 
	    {
	    	...
	    	um.LaunchApp();
	    	res=um.TC_555(updatestuname, updatestupwd);
	    	System.out.println("Case21: Result of Test Case Id::555   is->"+res);
	    	um.closeApp();*/
